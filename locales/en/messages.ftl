...
verify_app_command_verify_title = Verify account
...
discord-tag-slash-group-description = Tag related commands.
discord-tag-slash-create = create
discord-tag-slash-create-description = Create a new tag. Only the sky is the limit.
