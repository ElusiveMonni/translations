...
number-select-modal-field-placeholder = Napište číslo tohoto { $item } tady...
discord-slash-tag-get-describe-tag = Štítek na poslání.
discord-slash-reminder = připomínka
discord-slash-reminder-description = Připomenutí související příkazy.
discord-slash-reminder-create = vytvořit
discord_permission_use_external_apps = použít_externí_aplikace
verified_account_context_menu_name = Ověřený účet
verify_app_command_name = ověřit
verify_app_command_description = Ověřte účet pomocí Monni.
discord-slash-reminder-create-description = Vytvořte nové připomenutí. neboj se, Monni nezapomene.
discord-slash-reminder-create-describe-about = Téma, kterého se připomenutí týká.
discord-slash-reminder-create-describe-description = Popis upomínky.
...
discord-tag-embed-footer-id = ID štítku: { $tag_id }
tag-manage-view-edit-button = Upravit štítek
tag-manage-view-delete-button = Smazat štítek
tag-manage-edit-modal-tag-name-label = Jméno štítku
tag-manage-edit-modal-tag-name-placeholder = Jméno tady...
tag-manage-edit-modal-tag-content-label = Obsah štítku
tag-manage-edit-modal-tag-content-placeholder = Obsah tady...
tag-manage-edit-modal-on-error = Něco se pokazilo.
discord-tag-manage-message-no-tags = Zdá se, že momentálně nemáte žádné štítky. Můžete jej vytvořit pomocí /create tag.
discord-slash-tag-manage-name = spravovat
discord-slash-tag-manage-description = Spravujte své štítky
discord-slash-tag-manage-describe-tag = Označte k spravování. Chcete-li vybrat ze seznamu značek, ponechte prázdné.
tag-feature = štítek
unknown-tag = Neznámý štítek.
discord-tag-paginator-select-label = Vyberte štítek
discord-tag-manage-embed-list-title = Štítky
discord-tag-manage-message-tag-select = Vyberte štítek, který chcete upravit
non-allowed-action = Tuto akci nemáte dovoleno provést.
something-went-wrong = Něco se pokazilo.
number-select-invalid-number = Neplatné číslo.
number-select-modal-item = item
number-select-modal-title = Vyberte { $item }
number-select-modal-field-label = Napište { $item } číslo pro výběr
reminder-manage-enable-repeating-button = Proměňte v opakované připomenutí
reminder-manage-disable-repeating-button = Vypnout opakování
reminder-manage-delete-reminder-button = Smazat připomenutí
discord-reminder-manage-embed-list-title = Připomenutí
discord-reminder-paginator-select-label = Vyberte připomenutí
discord-reminder-paginator-select-item-name = připomenutí
discord-reminder-manage-message-select = Vyberte připomenutí, které chcete upravit
...
discord-tag-slash-get-description = Získejte značku podle ID, názvu nebo části obsahu.
discord-tag-create-message-over-freemium-limit = Můžete mít maximálně { $max_tags } značek. S prémií můžete tento limit zvýšit na { $max_premium_tags }.
content-editor-modal = Editor obsahu
discord-slash-tag-get-describe-hidden = Pošlete tuto zprávu soukromě, aby zůstala viditelná pouze vám.
...
discord-slash-reminder-create-describe-time = Čas, kdy by vám to Monni měla připomenout.
discord-reminder-create-message-created = Bylo vytvořeno nové připomenutí
discord-slash-reminder-manage-description = Spravujte svá připomenutí
discord-send-reminder-text = Požádali jste Monni, aby vám to připomněla na následujícím [kanálu]({ $jump_url }). Toto připomenutí bylo vytvořeno v { $time } ({ $relative_time })
